...
Inherits="AgrocomercioWEB.Maestros.WebForms.wfrmClientes" Theme="TemaAgrocomercio" StylesheetTheme="TemaAgrocomercio" %>
                ...
                <asp:GridView ID="gvwClientes" runat="server" Width="648px" 
                    ...
                    <asp:TemplateField  ItemStyle-Font-Size="10pt">
                        <ItemTemplate>
                            ...
                            CommandArgument='<%# Eval("cliCod") %>'>[Editar]</asp:LinkButton>
                        </ItemTemplate>                
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            CommandArgument='<%#Eval("cliCod")%>'>[Eliminar]</asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle Font-Size="10px" Width="8px" />
                        <ItemStyle Font-Size="8pt" Width="8px"  HorizontalAlign="Center"/>
                    </asp:TemplateField>
