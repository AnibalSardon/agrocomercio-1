                                ...
                                <td class="tabIzquierda" valign="top">
                                    <asp:Panel ID="pnNotas" runat="server" BackColor="White">
                                        <table class="tabFormularios">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <asp:Panel ID="pncargar" BorderColor="#549900" BorderStyle="Solid" runat="server">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    Fecha de pago:
                                                                ...
                                                                <asp:CalendarExtender ID="txtFec_CalendarExtender" runat="server" Enabled="True"
                                                                    Format="yyyy-MM-dd" PopupButtonID="Image2" TargetControlID="txtFec">
