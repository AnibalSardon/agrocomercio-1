    ...
    public class BasePage : System.Web.UI.Page
    {
            ...
            ref double pcIgv, ref double pcCostoTotal)
        {
            ...
            else // PARA VENTAS
            {
                ...
                //if (TipCalIGV == "2")
                //{
                //    nDescuento += (nSubTotal - nValorVenta);
                //    nValorVenta = nSubTotal - nDescuento + nFlete;
                //    nIGV = Math.Round(nValorVenta * nTasIGV, 2);
                //    nTotal = Math.Round(nValorVenta + nIGV, 2);
                //}
                //else
                //{
                //    double nTotSinDes = nSubTotal;
                //    double nTotConDes = nValorVenta;
