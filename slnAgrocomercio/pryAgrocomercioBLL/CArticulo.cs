...
#region metodos_publicos_ABM
        ...
        public MaestrosDataSet.ArticulosDataTable fnListaArticulos()
        {
            MaestrosDataSet.ArticulosDataTable ArticulosDataTable = new MaestrosDataSet.ArticulosDataTable();
            //CHProductosTableAdapter ProductosAdapter = new CHProductosTableAdapter();
        ...
        public int fnArticuloDelete(int pArtCod)
        {
            ...
            try
            {
                regAfectados = ArticuloAdapter.Delete(pArtCod);
                if (regAfectados <= 0)
                {
                    NroError = 998;
