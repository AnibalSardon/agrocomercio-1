...
#region propiedades_Capa_de_Datos
        ...
        public CCliente(int pCliCodigo)
        {
            ...
            //this.CliEstado = Convert.ToBoolean( drCliente["CliEstado"].ToString());
        }
        ...
        public MaestrosDataSet.ClientesDataTable fnListaClientes()
        {
        ...
        public int fnClienteDelete(int pCliCodigo)
        {
            ...
            try
            {
                regAfectados = ClienteTableAdapter.Delete(pCliCodigo);
                if (regAfectados <= 0)
                {
                    NroError = 998;
